...
class Dbjointpurchase extends Module
{
    ...
    public function install()
    {
        ...
        $sql = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'dbjoint_products_custom` (
    ...
    public function getProductsGenerate($id_product)
    {
        ...
        $selectedProducts = Db::getInstance()->executeS('
            SELECT *
            FROM '._DB_PREFIX_.'dbjoint_products_custom
        ...
        if ($selectedProducts) {
            ...
            foreach ($selectedProducts as $product) {
                $relatedIds[] = $product['joint_1'];
                $relatedIds[] = $product['joint_2'];
                $relatedIds[] = $product['joint_3'];
            }
            ...
            // Si el producto no está en la tabla, mantener el comportamiento actual
    ...
    return $this->display(__FILE__, 'views/templates/admin/adminProductsExtra.tpl');
    }
    /////////////////////////////
}